        ...
        <div class="col-md-6 col-md-offset-3">
            <form action="addTextIn" method="post" class="form-horizontal">
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-9">
                        <input type="file" id="text_inForm" name="text_title" path="text_path" class="form-control" placeholder="<fmt:message key="register.form.text.title.placeholder"/>">
...
<div class="form-group">
                            ...
                            <div class="col-sm-9">
                        <input type="text" id="text_pathForm" name="text_path"  class="form-control" placeholder="<fmt:message key="register.form.text.path.placeholder"/>">
    </div>
    </div>
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-30">
                        <div class="row-sm-50">
                            <textarea id="text_path" name="titles" aria-setsize="100" class="form-control" placeholder="<fmt:message key="register.form.titles.placeholder"/>">
                        </textarea>
                        ...
                        <div class="container-fluid">
                                ...
                                <input type="hidden" >
                                <select title="locale" name="language_of_subtitles" class="form-control input-sm"
